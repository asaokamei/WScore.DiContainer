...
use \WScore\DiContainer\Storage\IdWithNamespace as Storage;

class IdWithNamespace_Test extends \PHPUnit_Framework_TestCase
{
    /** @var Storage */
    var $values;
    ...
    {
        $this->assertEquals( 'WScore\DiContainer\Storage\IdWithNamespace', get_class( $this->values ) );
    }
    ...
    public function test_namespace_is_strictly_used()
    {
        ...
        $this->assertEquals(  null,    $this->values->fetch( 'only', 'named' ) );
    }
